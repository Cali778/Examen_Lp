...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listPerson.add(new Person(1,"Andres","Mamani","Capel","www.capel.com","Av: Manuel Nuñez B. 212 - Juliaca",R.drawable.descarga));
        ...
        PersonListAdapter adapter = new PersonListAdapter(this,listPerson);
